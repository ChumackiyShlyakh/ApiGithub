...
import com.gd.oshturniev.apigithub.dagger.DaggerGitHubComponent;
import com.gd.oshturniev.apigithub.dagger.GitHubComponent;
...
public class MainActivity extends AppCompatActivity implements Callback<UserResponse> {
            ...
            public void onChanged(@Nullable Integer integer) {
                switch (integer) {
                    case R.id.nav_following:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, component.getFollowingFragment()).commit();
                        break;
                    case R.id.nav_repositories:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, component.getGitFragment()).commit();
                        break;
    ...
    public void onLogOut() {
        ...
        RoomDBFollowing roomDBFollowing = new RoomDBFollowing(getApplication());
        roomDBFollowing.deleteAll();
